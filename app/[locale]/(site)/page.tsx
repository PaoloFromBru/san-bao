    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <ServiceCard locale={locale} title={dict.home.cardShiatsu} href="/services/shiatsu" img="/img-shiatsu.svg" />
          <ServiceCard locale={locale} title={dict.home.cardNaturopathy} href="/services/naturopathy" img="/img-naturopathy.svg" />
          <ServiceCard locale={locale} title={dict.home.cardInfant} href="/services/infant-massage" img="/img-infant.svg" />
        </div>
      </section>
