...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  const path = `/${locale}/services/infant-massage`;
  const languages = Object.fromEntries(locales.map((l) => [l, `/${l}/services/infant-massage`]));
  (languages as any)["x-default"] = "/it/services/infant-massage";
  return {
    ...
    openGraph: { title: dict.meta.services.infant.title, description: dict.meta.services.infant.description, url: `${siteUrl}${path}` },
