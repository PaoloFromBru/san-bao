...
export const dictionary = {
  meta: {
    ...
    siteDescription: "Natural wellbeing in Brussels. Shiatsu, Qi Nei Zang, Naturopathy, Baby massage.",
    ...
    services: {
      ...
      infant: { title: "Baby massage – San Bao", description: "Gentle touch that supports calm, sleep and harmonious growth." }
    }
  },
  nav: {
    shiatsu: "Shiatsu",
  ...
  about: {
    content: `San Bao is built on a personalised approach to wellbeing, inspired by "three treasures": body, energy and spirit. My aim is to accompany you towards harmony with attentive and tailor-made guidance.

Since 2010 I have explored many therapeutic disciplines: Shiatsu, Qi Nei Zang, Reiki, herbalism, naturopathy and geobiology as well as numerous workshops that deepen my understanding of the body and its energies.
...
These experiences let me offer holistic support that combines bodywork, lifestyle advice and careful listening so you can become the actor of your own balance. I look forward to meeting you!`,
    more: `I founded San Bao because I believe in a personalised approach to your well-being, as each individual is unique. The name "San Bao" in Chinese medecine means the "three treasures": Jing (the vital essence), Qi (the energetic flow), Shen (the spirit). I apply the symbol of the 3 treasures working on the body, energy and spirit.

My mission is to support you on the path to harmony, I'll be your guide to holistic well-being.
...
• Shiatsu and Qi Nei Zang:
   - well-being shiatsu (Masunaga) with Philippe Vandenabeele – Shinzuikai 2013/2014.
...
My goal is that you become the actor of your own balance.
...
Christel`
  ...
  services: {
    ...
    faceMassage: {
      title: "Face massage",
      lead: "Discover the glow of a 50-minute Kobido face massage that boosts microcirculation and reveals radiant skin.",
      cta: "Book now",
