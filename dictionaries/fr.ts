...
Christel`
  ...
  services: {
      ...
      qiNeiZang: {
        ...
        cta: "Prendre rendez‑vous",
        more: "Le Qi Nei Zang (ou Chi Nei Tsang) est un massage du ventre qui permet de libérer les émotions et d'apaiser les tensions.\nEn agissant sur les intestins, il procure une détente profonde, réduit le stress et l'anxiété, soulage les douleurs physiques (lombalgies par exemple) et les troubles de l'appareil digestif et reproducteur. Grâce au massage des organes internes, le Qi Nei Zang aide aussi à stimuler le système immunitaire de manière préventive et indirecte.\n\nLa séance de Qi Nei Zang dure 1 heure et coûte 65€.",
      },
    naturopathy: {
      title: "Naturopathie",
