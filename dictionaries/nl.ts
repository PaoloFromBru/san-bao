...
Christel`
  ...
  services: {
      ...
      qiNeiZang: {
        ...
        cta: "Boek nu",
        more: "Qi Nei Zang (of Chi Nei Tsang) is een buikmassage die emoties bevrijdt en spanningen loslaat.\nDoor in te werken op de darmen zorgt het voor diepe ontspanning, vermindert het stress en angst, verlicht het fysieke pijn (zoals lage rugpijn) en klachten van het spijsverterings- en voortplantingsstelsel. Dankzij de massage van de inwendige organen helpt Qi Nei Zang ook het immuunsysteem preventief en indirect te stimuleren.\n\nEen Qi Nei Zang-sessie duurt 1 uur en kost €65.",
      },
    naturopathy: {
      title: "Naturopathie",
